...
public class UnitDetailsWindowContoller : MonoBehaviour
{
    ...
    public void BuildPanel(CharacterInfo unit)
    {
        ...
        unitDetailsPanel.transform.Find("PHY_Value").GetComponent<TextMeshProUGUI>().text = unit.characterData.HP_CURRENT + "/" + unit.characterData.HP;
